...
Make sure you set replicas for all Spinnaker services to 0. The following example for the Operator shows what that looks like in the `SpinnakerService` manifest for the service `gate`:
